...
def speculative_generate(
    ...
    input_ids = torch.full((1, total_len), pad_token_id or 0, dtype=torch.long, device=target.device)
    ...
    print(current_position, total_len)
    while current_position < total_len:
        ...
        input_ids[0, current_position + n:current_position + corrected_gamma] = pad_token_id or 0
